INSERT INTO consulta_cliente (id, nombrecliente, telefono, cedula, email, numerocredito, banco, estado, idproducto,idbanco,convenio, valorapagar, tipoproducto, valormora) VALUES
(1,'LOPEZ LOPEZ LUIS EMILIO','3005632010','56789066','elisabeth.becerra@samtel.co','6000000456','BANCO COMERCIAL AVVILLAS','Cerrado','9991','52','MARCALI INTERNACIONAL SA', 1500000, 1, 10000),
(2,'GOMEZ GARCIA LUISA CLRA','3005632011','56789098','jesus.sierra@samtel.co','6000000457','BANCO COMERCIAL AVVILLAS','Cerrado','200','52','SIDA S.A.', 1800000,2, 10000),
(3,'ALONSO ALONSO ALONSO','3005632012','1234567','a.alvarezb@ext.santanderconsumer.co','6000000458','BANCO COMERCIAL AVVILLAS','Cerrado','1','52','MARKIA SA', 2100000, 2,200000),
(4,'PEREZ PEREZ MARIA LUISA','3005632013','56789063','elisabeth.becerra@samtel.co','6000000459','BANCO COMERCIAL AVVILLAS','Cerrado','1','52','MOTOVALLE S.A.S', 3500000, 2,25000),
(5,'GARCIA CARBALLO MANUEL CARLOS','3005632014','9535344','jesus.sierra@samtel.co','6000000460','BANCO SANTANDER DE NEGOCIOS COLOMBIA S.A. - BANCO SANTANDER','Cerrado','9991','65','AUTOMOTORES COMAGRO SAS', 800000,2, 350000),
(6,'OUTEIRO LAMAS FERNANDO','3005632015','19977690','alfredoparra67@hotmailcom','6000000461','SANTANDER CONSUMER','Al dia','1','9000','LOS COCHES F SAS',700000, 1,0),
(7,'RADIO RADIO LAURA LUISA','3005632016','1019890877','elisabeth.becerra@samtel.co','6000000462','SANTANDER CONSUMER','Al dia','9991','9000','CALIMA MOTOR S.A',650000, 1,0);
...
INSERT INTO usuario_app(id, password, usuario)
 ...
 INSERT INTO consulta_cliente (id, nombrecliente, telefono, cedula, email, numerocredito, banco, estado, idproducto,idbanco,convenio, valorapagar, tipoproducto, valormora) VALUES
 (8,'JESUS NICOLAS SIERRA CHAPARRO','3229034455','1030589632','jesus.sierraa@gmail.com','6000000463','BANCO COMERCIAL AVVILLAS','Cerrado','9991','52','MARCALI INTERNACIONAL SA', 500000, 1,10000),
 (9,'JESUS  CHAPARRO','3229034456','1030589633','jesus.sierrac@gmail.com','6000000464','BANCO COMERCIAL AVVILLAS','Cerrado','9991','52','MARCALI INTERNACIONAL SA',800000, 2, 50000),
 (10,'JESUS  CHAPARRO','3229034456','1030589633','jesus.sierrac@gmail.com','6000000465','BANCO COMERCIAL AVVILLAS','Al dia','9991','200','MARCALI INTERNACIONAL SA',560000, 3,0 ),
 (11,'JOHN  MORENO','3229039985','1030589656','john.moreno@gmail.com','6000000466','BANCO COMERCIAL AVVILLAS','Cerrado','9991','52','MARCALI INTERNACIONAL SA', 350000,1, 10000),
 (12,'JOHN  MORENO','3229039985','1030589656','john.moreno@gmail.com','6000000466','BANCO COMERCIAL AVVILLAS','Cerrado','9991','52','MARCALI INTERNACIONAL SA', 350000,1, 25000),
 (13,'Pepito','3229039988','41584206','john.moreno1@gmail.com','830000000185','BANCO COMERCIAL AVVILLAS','Al dia','9991','200','MARCALI INTERNACIONAL SA', 960000,1,85000);
